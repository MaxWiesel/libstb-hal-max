...
bool cDemux::pesFilter(const unsigned short _pid)
{
	...
	switch (dmx_type)
	{
		case DMX_VIDEO_CHANNEL:
			...
			{
				case 0:
					p_flt.pes_type = DMX_PES_VIDEO0;
					break;
				case 1:
					p_flt.pes_type = DMX_PES_VIDEO1;
					break;
				case 2:
					p_flt.pes_type = DMX_PES_VIDEO2;
					break;
				case 3:
					p_flt.pes_type = DMX_PES_VIDEO3;
					break;
			}
			break;
		case DMX_AUDIO_CHANNEL:
			...
			{
				case 0:
					p_flt.pes_type = DMX_PES_AUDIO0;
					break;
				case 1:
					p_flt.pes_type = DMX_PES_AUDIO1;
					break;
				case 2:
					p_flt.pes_type = DMX_PES_AUDIO2;
					break;
				case 3:
					p_flt.pes_type = DMX_PES_AUDIO3;
					break;
			}
			break;
		...
		case DMX_PCR_ONLY_CHANNEL:
			...
			{
				case 0:
					p_flt.pes_type = DMX_PES_PCR0;
					break;
				case 1:
					p_flt.pes_type = DMX_PES_PCR1;
					break;
				case 2:
					p_flt.pes_type = DMX_PES_PCR2;
					break;
				case 3:
					p_flt.pes_type = DMX_PES_PCR3;
					break;
			}
			break;
		default:
